      ...
      "conditions": [
        ['OS=="win"', {
          "include_dirs": [
            ...
            "<(module_root_dir)/sdk/bt-sdk-1.1.2/build/native/include"
          ],
          "libraries": [
            ...
            "<(module_root_dir)/sdk/bt-sdk-1.1.2/lib/native/amd64/release/k4abt.lib"
          ],
          "copies": [
            {
          ...
          "include_dirs": [
            ...
            "<(module_root_dir)/sdk/bt-sdk-1.1.2/build/linux/include"
          ],
          "libraries": [
            ...
            "<(module_root_dir)/sdk/bt-sdk-1.1.2/lib/linux/amd64/release/libk4abt.so.1.1.2"
          ],
          "copies": [
            {
              "destination": "<(module_root_dir)/build/Release",
